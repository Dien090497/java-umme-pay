...
import vn.unicloud.umeepay.dtos.customer.request.UpdateCustomerRequest;
...
public class UpdateCustomerHandler extends RequestHandler<UpdateCustomerRequest, CustomerResponse> {
    ...
    @Override
    public CustomerResponse handle(UpdateCustomerRequest request) {
