...
public class GetCustomerGroupHandler extends RequestHandler<GetCustomerGroupRequest, CustomerGroupResponse> {
    ...
    @Override
    public CustomerGroupResponse handle(GetCustomerGroupRequest request) {
