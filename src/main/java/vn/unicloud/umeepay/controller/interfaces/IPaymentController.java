...
public interface IPaymentController {
    ...
    ResponseEntity<ResponseBase<CreateTransactionResponse>> createTransaction(
    ...
    @PostMapping(value = "/v1/query")
    ResponseEntity<ResponseBase<QueryTransactionResponse>> checkTransaction(
        @RequestHeader("x-api-client") String keyId,
        @RequestHeader("x-api-validate") String signature,
        @RequestHeader("x-api-time") Long timestamp,
        @Valid @RequestBody EncryptedBodyRequest request
    ...
    ResponseEntity<ResponseBase<CancelTransactionResponse>> cancelTransaction(
        @RequestHeader("x-api-client") String keyId,
        @RequestHeader("x-api-validate") String signature,
        @RequestHeader("x-api-time") Long timestamp,
        @Valid @RequestBody EncryptedBodyRequest request
